        ...
        <ng-container *ngIf="activeTab === 'contact'">
          ...
          <section class="cs-section">
            ...
            <div class="cs-hours-card">
              <div
                class="cs-hours-row"
                *ngFor="let h of hours; let last = last"
                [class.last]="last"
              >
          ...
          <section class="cs-section">
            ...
            <div class="cs-faq-list">
              ...
              >
                ...
                <p class="cs-faq-answer" *ngIf="expandedId === faq.id">
                  {{ faq.answer }}
                </p>
              </div>
            </div>
  ...
  styles: [
    `
      ...
      /* ── Dark-mode card surface ──
       var(--color-surface) is the page/sidebar background (very dark).
       We need a slightly elevated tone for cards. Use a local fallback
       that is visibly lighter than the page background in dark mode.      */
      :host {
        --card-bg: color-mix(
          in srgb,
          var(--color-surface, #1a1a1a) 60%,
          #fff 8%
        );
        --input-bg: color-mix(
          in srgb,
      ...
      /* Active tab: use primary accent so it's clearly selected */
      .cs-tab.active {
      ...
      /* Textarea inherits the card surface so it blends; a subtle border distinguishes it */
      .cs-textarea {
        width: 100%;
        border-radius: 10px;
        border: 1px solid var(--border-color);
...
export class CustomerServiceComponent implements OnInit {
  ...
  faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer:
        'Yes, you can cancel or reschedule bookings from "My Bookings". Please note that cancellation policies vary by salon. Some may charge a fee for late cancellations.',
      category: "Booking",
    },
    {
      id: "3",
      ...
      answer:
        'After your appointment, go to "My Bookings", select the completed booking, and tap "Leave a Review". Your feedback helps other users!',
      category: "Reviews",
    },
    {
      id: "4",
      ...
      answer:
        "Yes, all personal information is encrypted and stored securely. We never share your data with third parties without your consent.",
      category: "Security",
    },
    {
      id: "5",
      ...
      answer:
        "Share your unique referral code with friends. When they sign up and complete their first booking, you both receive GHS 20 credit.",
      category: "Rewards",
    },
    {
      id: "6",
      ...
      answer:
        "Yes, go to Profile > Profile Settings to update your name, email, phone number, and profile picture.",
      category: "Account",
    },
  ];
